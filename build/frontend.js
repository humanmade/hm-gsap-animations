...
/* harmony export */   ANIMATION_PRESETS: () => (/* binding */ ANIMATION_PRESETS),
/* harmony export */   HOVER_PRESETS: () => (/* binding */ HOVER_PRESETS)
/* harmony export */ });
/**
...
/* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./animations */ "./src/frontend/animations.js");
...
function initPresetAnimation(element) {
  ...
  const preset = _animations__WEBPACK_IMPORTED_MODULE_3__.ANIMATION_PRESETS[animation];
  if (!preset) return;
  ...
  const targets = staggerVal !== null ? resolveStaggerTargets(element, element.dataset.gsapStaggerTarget || 'children') : element;
  ...
  // while scrolling up.
  if (mode === 'scrub') {
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(targets, {
      ...preset,
      ...(staggerVal !== null ? {
        stagger: staggerVal
      } : {}),
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(targets, tweenVars);
}
...
function initCountUpAnimation(element) {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(counter, tweenVars);
}
...
function initHoverAnimation(element) {
  ...
  const toState = _animations__WEBPACK_IMPORTED_MODULE_3__.HOVER_PRESETS[effect];
  if (!toState) return;
...
function initSplitAnimation(element) {
  ...
  const preset = _animations__WEBPACK_IMPORTED_MODULE_3__.ANIMATION_PRESETS[animation];
  const [result] = splitting__WEBPACK_IMPORTED_MODULE_2___default()({
    target: element,
    by
  });
...
function initParallaxAnimation(element) {
  ...
  const bgMedia = element.querySelector('.wp-block-cover__image-background, .wp-block-cover__video-background');
  if (bgMedia) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(bgMedia, {
      yPercent: -half
    }, {
      yPercent: half,
      ease: 'none',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(element, {
